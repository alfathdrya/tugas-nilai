                            ...
                            while ($r = mysqli_fetch_assoc($result)) {
                                echo '<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?m=mapel&s=delete&id='.$r['id'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin mapel akan dihapus?, Hapus 1 mapel akan menghapus semua data mapel di mapel tersebut\')">Hapus</a>
                                    </td>
                                </tr>';
                                $no++;
                            }
